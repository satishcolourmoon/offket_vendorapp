...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["clone-categorieslist-clone-categorieslist-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppCloneCategorieslistCloneCategorieslistPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppCloneCategorieslistCloneCategorieslistRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CloneCategorieslistPageRoutingModule", function () {
      return CloneCategorieslistPageRoutingModule;
    });
    /* harmony import */
    ...
    var _clone_categorieslist_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./clone-categorieslist.page */
    ...
    var CloneCategorieslistPageRoutingModule = function CloneCategorieslistPageRoutingModule() {
      _classCallCheck(this, CloneCategorieslistPageRoutingModule);
    };

    CloneCategorieslistPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppCloneCategorieslistCloneCategorieslistModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CloneCategorieslistPageModule", function () {
      return CloneCategorieslistPageModule;
    });
    /* harmony import */
    ...
    var _clone_categorieslist_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./clone-categorieslist-routing.module */
    "./src/app/clone-categorieslist/clone-categorieslist-routing.module.ts");
    /* harmony import */


    var _clone_categorieslist_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./clone-categorieslist.page */
    "./src/app/clone-categorieslist/clone-categorieslist.page.ts");

    var CloneCategorieslistPageModule = function CloneCategorieslistPageModule() {
      _classCallCheck(this, CloneCategorieslistPageModule);
    };

    CloneCategorieslistPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _clone_categorieslist_routing_module__WEBPACK_IMPORTED_MODULE_5__["CloneCategorieslistPageRoutingModule"]],
  ...
  /***/
  function srcAppCloneCategorieslistCloneCategorieslistPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppCloneCategorieslistCloneCategorieslistPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CloneCategorieslistPage", function () {
      return CloneCategorieslistPage;
    });
    /* harmony import */
    ...
    var CloneCategorieslistPage = /*#__PURE__*/function () {
      function CloneCategorieslistPage(util, actRoute, router, api, popoverController, loadingCtrl) {
        _classCallCheck(this, CloneCategorieslistPage);
      ...
      _createClass(CloneCategorieslistPage, [{
        key: "ngOnInit",
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  ...
                  case 3:
                    ...
                    loading.present();
                    this.api.fetchShopCategories(function (response) {
                      loading.dismiss();

                      if (response.status == true) {
                        _this.categories = response.category_list;
                        _this.nval = true;
                      } else {
                        _this.nval = false;
        ...
        key: "gotoPage",
        value: function gotoPage(cid, title, shopId) {
          this.router.navigate(['clone-subcategories', {
            catId: cid,
            catName: title,
            shopId: shopId
          }]);
    ...
    CloneCategorieslistPage.ctorParameters = function () {
      return [{
    ...
    CloneCategorieslistPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-clone-categorieslist',
      template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! raw-loader!./clone-categorieslist.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/clone-categorieslist/clone-categorieslist.page.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./clone-categorieslist.page.scss */
      "./src/app/clone-categorieslist/clone-categorieslist.page.scss"))["default"]]
    })], CloneCategorieslistPage);
    /***/
  }
}]);
//# sourceMappingURL=clone-categorieslist-clone-categorieslist-module-es5.js.map