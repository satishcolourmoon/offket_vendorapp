...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["plans-plans-module"], {
  ...
  function srcAppPlansPlansPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var PlansPage = /*#__PURE__*/function () {
      function PlansPage(util, actRoute, router, api, popoverController, loadingCtrl, menu) {
      ...
      _createClass(PlansPage, [{
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    this.api.fetchPlans(function (response) {
        ...
        key: "viewPlan",
        value: function viewPlan(pid, title) {
                ...
                switch (_context2.prev = _context2.next) {
                  case 0:
                    ...
                    this.api.fetchShopDetails(function (response) {
                      ...
                      if (response.status == true) {
                        _this2.offer_zone = response.offer_zone;

                        if (_this2.offer_zone == 'yes') {
