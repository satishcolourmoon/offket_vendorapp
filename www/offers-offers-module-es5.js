...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["offers-offers-module"], {
  ...
  function srcAppOffersOffersModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    OffersPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _offers_routing_module__WEBPACK_IMPORTED_MODULE_5__["OffersPageRoutingModule"], ngx_ionic_image_viewer__WEBPACK_IMPORTED_MODULE_7__["NgxIonicImageViewerModule"]],
  ...
  function srcAppOffersOffersPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var OffersPage = /*#__PURE__*/function () {
      function OffersPage(util, actRoute, router, api, popoverController, loadingCtrl, alertController, menu) {
      ...
      _createClass(OffersPage, [{
                  ...
                  case 0:
                    ...
                    this.api.fetchShopDetails(function (response) {
                      ...
                      if (response.status == true) {
                        _this.offer_zone = response.offer_zone;

                        if (_this.offer_zone == 'yes') {
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  ...
                  case 4:
                    ...
                    loading.present();
                    this.api.fetchOffers(function (response) {
                      loading.dismiss();
                      ...
                      if (response.status == true) {
                        ...
                        _this2.nval = false;
                        _this2.offers = [];
                        _this2.image = response.image; //this.util.presentToast(response.message, 'danger', 'bottom', 2500);
                      }
                    }, catObj);
                ...
                switch (_context3.prev = _context3.next) {
                  case 0:
                    ...
                    this.api.getPackageReport(function (response) {
                      if (response.status == true) {
                        _this3.banners_count = response.offers;
                      } else {
                        _this3.banners_count = response.offers; //this.router.navigate(['plans']);
                      }
                    }, catObj);
        ...
        key: "editBanner",
        value: function editBanner(bid, image, title, imagefile, cat_id, start_date, end_date) {
          this.router.navigate(['addoffers', {
            id: bid,
            image: image,
            title: title,
                    ...
                    return this.alertController.create({
                      ...
                      buttons: [{
                        ...
                        handler: function handler() {
                          ...
                          _this4.api.deleteBanner(function (response) {
                            if (response.status == true) {
