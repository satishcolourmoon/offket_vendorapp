...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["sales-sales-module"], {
  ...
  function srcAppSalesSalesPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var SalesPage = /*#__PURE__*/function () {
      function SalesPage(camera, util, router, actRoute, loadingCtrl, actionSheetController, file, api) {
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  ...
                  case 3:
                    ...
                    loading.present();
                    this.api.fetchSalesReport(function (response) {
                      loading.dismiss();

                      if (response.status == true) {
                        _this2.sales = response.orders;
                        _this2.nval = true;
                      } else {
                        _this2.nval = false;
              ...
              while (1) {
                switch (_context3.prev = _context3.next) {
                  ...
                  case 7:
                    ...
                    loading.present();
                    this.api.getDatewisesalesReport(function (response) {
                      loading.dismiss();

                      if (response.status == true) {
                        _this3.sales = response.orders;
                        _this3.nval = true;
                      } else {
                        _this3.nval = false;
