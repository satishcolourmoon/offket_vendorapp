...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["request-new-product-request-new-product-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppRequestNewProductRequestNewProductPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppRequestNewProductRequestNewProductRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "RequestNewProductPageRoutingModule", function () {
      return RequestNewProductPageRoutingModule;
    });
    /* harmony import */
    ...
    var _request_new_product_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    ...
    var RequestNewProductPageRoutingModule = function RequestNewProductPageRoutingModule() {
      _classCallCheck(this, RequestNewProductPageRoutingModule);
    };

    RequestNewProductPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppRequestNewProductRequestNewProductModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "RequestNewProductPageModule", function () {
      return RequestNewProductPageModule;
    });
    /* harmony import */
    ...
    var _request_new_product_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./request-new-product-routing.module */
    "./src/app/request-new-product/request-new-product-routing.module.ts");
    /* harmony import */


    var _request_new_product_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./request-new-product.page */
    "./src/app/request-new-product/request-new-product.page.ts");

    var RequestNewProductPageModule = function RequestNewProductPageModule() {
      _classCallCheck(this, RequestNewProductPageModule);
    };

    RequestNewProductPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _request_new_product_routing_module__WEBPACK_IMPORTED_MODULE_5__["RequestNewProductPageRoutingModule"]],
  ...
  /***/
  function srcAppRequestNewProductRequestNewProductPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppRequestNewProductRequestNewProductPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "RequestNewProductPage", function () {
      return RequestNewProductPage;
    });
    /* harmony import */
    ...
    var RequestNewProductPage = /*#__PURE__*/function () {
      function RequestNewProductPage(util, router, actRoute, loadingCtrl, api, camera, actionSheetController, file, transfer, crop, imagePicker) {
        _classCallCheck(this, RequestNewProductPage);
      ...
      _createClass(RequestNewProductPage, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          ...
          this.getproductTags();
          this.getproductBrands(); //this.getproductTypes();
        ...
        value: function getproductBrands() {
          ...
          var brandObj = {
            action: "getBrands",
            subcatid: this.subcategory
          };
          this.api.getBrands(function (response) {
            setTimeout(function () {
              if (response.status == true) {
                _this2.brands = response.brands;
              } else {//this.util.presentToast(response.message, 'danger', 'bottom', 2500);
              }
            }, 500);
          }, brandObj);
        ...
        value: function getproductTypes() {
          ...
          this.api.getTypes(function (response) {
            if (response.status == true) {
              _this3.types = response.types;
            } else {//this.util.presentToast(response.message, 'danger', 'bottom', 2500);
            }
          }, brandObj);
        }
        ...
        value: function getshopCategories() {
          ...
          this.api.getCategories(function (response) {
            setTimeout(function () {
              ...
              if (response.status == true) {
                _this5.categories = response.category_list;
              } else {//this.util.presentToast(response.message, 'danger', 'bottom', 2500);
              }
            }, 500);
          }, catObj);
        ...
        value: function doProduct() {
          ...
          if (this.product_name == '' || this.product_name == undefined) {
            ...
            this.content.scrollToPoint(1500, 67, 1500); //this.cName.setFocus();

            this.util.presentToast("Select Category", 'danger', 'top', 2500);
          } else if (this.subcategory == '' || this.subcategory == undefined) {
            this.content.scrollToPoint(1500, 112, 1500); //this.subc_Name.setFocus();
            ...
            var requestProd = {
              ...
              sub_cat_id: this.subcategory,
              key_features: this.key_fetures,
            ...
            this.util.showLoader();
            this.api.requestProduct(function (response) {
              _this6.util.hideLoader();

              if (response.status == true) {
                _this6.util.presentToast(response.message, 'primary', 'bottom', 2500);

                if (_this6.variant_product == 'yes') {
                  _this6.router.navigate(['addvariant', {
                    pid: response.product_id,
                    page: "product"
                  }]);
                } else {
                  _this6.router.navigate(['linkproducts', {
                    pid: response.product_id,
                    page: "product"
                  }]);
                }
        ...
        value: function getItems(ev) {
          ...
          if (keyword == '' || keyword == undefined) {
            ...
            this.api.searchProducts(function (response) {
              _this7.nval = 1;
        ...
        key: "getProductData",
        value: function getProductData(pid) {
          var _this8 = this;
          ...
          this.api.getProductData(function (response) {
            if (response.status == true) {
              _this8.product_details = response.product_details; //alert(JSON.stringify(this.product_details));

              _this8.pid = response.product_details.id;
              _this8.product_name = response.product_details.name;
              _this8.category = response.product_details.cat_id;
              _this8.subcategory = response.product_details.sub_cat_id;
              _this8.product_description = response.product_details.description;
              _this8.key_fetures = response.product_details.key_features;
              _this8.product_startdate = response.product_details.selling_date;
              var str = response.product_details.product_tags;
              _this8.product_tags = str.split(",");
              _this8.meta_tag_title = response.product_details.meta_tag_title;
              _this8.meta_tag_description = response.product_details.meta_tag_description;
              _this8.meta_tag_keywords = response.product_details.meta_tag_keywords;
              _this8.brand = response.product_details.brand_id;
              _this8.no_of_days = response.product_details.no_of_days;
              _this8.cancel_available = response.product_details.cancel_status;
              _this8.return_available = response.product_details.return_status;
              _this8.exchangestatus = response.product_details.exchangestatus;
              _this8.manage_stock = response.product_details.manage_stock;
              _this8.variant_product = response.product_details.variant_product;

              if (_this8.variant_product == 'yes') {
                _this8.variant = false;
              } else {
                _this8.variant = true;
              }

              _this8.status = response.product_details.status;
              _this8.price = response.product_details.price;
              _this8.sale_price = response.product_details.saleprice;
              _this8.stock = response.product_details.stock;
              _this8.availabile_stock_status = response.product_details.availabile_stock_status;
            } else {//this.util.presentToast(response.message, 'danger', 'bottom', 2500);
            }
          }, editProdObj);
        }
        ...
        value: function getSubCategoriesList(category) {
          ...
          this.api.fetchShopSubCategories(function (response) {
            setTimeout(function () {
              _this9.util.hideLoader();

              if (response.status == true) {
                _this9.sub_categories = response.subcategory_list; //alert(JSON.stringify(this.sub_categories));
              } else {//this.util.presentToast(response.message, 'danger', 'bottom', 2500);
                }
            }, 500);
          }, subcatObj);
        ...
        key: "getVariantProduct",
        value: function getVariantProduct() {
                    ...
                    return this.actionSheetController.create({
                      ...
                      buttons: [{
                        ...
                        handler: function handler() {
                          _this10.takePicture(_this10.camera.PictureSourceType.PHOTOLIBRARY);
                        }
                      }]
                    });
        ...
        value: function takePicture(sourceType) {
          ...
          this.imagePicker.getPictures({
            ...
            selectedImg.forEach(function (i) {
              var options1 = {
                fileKey: 'image',
                fileName: 'name.jpg',
                headers: {},
              ...
              var fileTransfer = _this11.transfer.create();

              fileTransfer.upload("data:image/jpeg;base64," + i, _this11.urlpath, options1, true).then(function (data) {
                _this11.imagepath.push(data.response); //this.title=this.title;
              ...
              _this11.images.push("data:image/jpeg;base64," + i);
            });
          });
        }
      }, {
        key: "existingProduct",
        value: function existingProduct(catId) {
          //this.router.navigate(['/existingproduct']);
          this.router.navigate(['clone-categorieslist', {
            catId: catId
          }]);
        }
      }, {
    ...
    RequestNewProductPage.ctorParameters = function () {
      return [{
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('prodName')], RequestNewProductPage.prototype, "pName", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('catName')], RequestNewProductPage.prototype, "cName", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('subcatName')], RequestNewProductPage.prototype, "subc_Name", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('pro_descName')], RequestNewProductPage.prototype, "pro_desc", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('keyfeatName')], RequestNewProductPage.prototype, "key_feat", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('proStartName')], RequestNewProductPage.prototype, "pro_sdate", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('pro_tagName')], RequestNewProductPage.prototype, "pro_tag", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('meta_titleName')], RequestNewProductPage.prototype, "meta_title", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('meta_descName')], RequestNewProductPage.prototype, "meta_desc", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('meta_keywordsName')], RequestNewProductPage.prototype, "meta_keywords", void 0);
    ...
    RequestNewProductPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-request-new-product',
      template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! raw-loader!./request-new-product.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/request-new-product/request-new-product.page.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./request-new-product.page.scss */
      "./src/app/request-new-product/request-new-product.page.scss"))["default"]]
    })], RequestNewProductPage);
    /***/
  }
}]);
//# sourceMappingURL=request-new-product-request-new-product-module-es5.js.map