...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["coupons-coupons-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppCouponsCouponsPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppCouponsCouponsPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppCouponsCouponsPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var CouponsPage = /*#__PURE__*/function () {
      function CouponsPage(util, actRoute, router, api, popoverController, loadingCtrl, alertController) {
      ...
      _createClass(CouponsPage, [{
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  ...
                  case 4:
                    ...
                    loading.present();
                    this.api.fetchCouponCodes(function (response) {
                      loading.dismiss();
                      ...
                      if (response.status == true) {
                        ...
                        _this2.nval = false;
                        _this2.coupons = []; //this.util.presentToast(response.message, 'danger', 'bottom', 2500);
                      }
                    }, catObj);
        ...
        key: "deleteCoupon",
        value: function deleteCoupon(cid) {
                    ...
                    return this.alertController.create({
                      ...
                      buttons: [{
                        ...
                        handler: function handler() {
                          ...
                          _this3.api.deleteCoupon(function (response) {
                            //loading.dismiss();
                            if (response.status == true) {
    ...
    CouponsPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-coupons',
      template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! raw-loader!./coupons.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/coupons/coupons.page.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./coupons.page.scss */
      "./src/app/coupons/coupons.page.scss"))["default"]]
    })], CouponsPage);
    /***/
  }
}]);
