...
let SubscriptionsPage = class SubscriptionsPage {
    ...
    getPlans() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            this.api.fetchSubscription((response) => {
    ...
    buyNow(pid, amount) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            this.api.generateRazerpay((response) => {
                if (response.status == true) {
    ...
    paymentSuccess(payment_id, razorpayOrderId, pid, paymentAmount, vendor_id) {
        ...
        this.api.doRazerpayPayment((response) => {
