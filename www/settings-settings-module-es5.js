...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["settings-settings-module"], {
  ...
  function srcAppSettingsSettingsPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var SettingsPage = /*#__PURE__*/function () {
      function SettingsPage(util, actRoute, router, api, popoverController, modalController) {
      ...
      _createClass(SettingsPage, [{
        ...
        value: function changePassword() {
          ...
          if (this.current_password == undefined || this.current_password == "") {
            ...
            this.api.changePassword(function (response) {
              //this.util.hideLoader();
              if (response.status == true) {
                _this.util.presentToast(response.message, 'primary', 'bottom', 2500);
