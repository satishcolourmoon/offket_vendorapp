...
/* harmony import */ var _editproduct_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./editproduct.page */ "./src/app/editproduct/editproduct.page.ts");
...
/* harmony import */ var _editproduct_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./editproduct-routing.module */ "./src/app/editproduct/editproduct-routing.module.ts");
/* harmony import */ var _editproduct_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./editproduct.page */ "./src/app/editproduct/editproduct.page.ts");
...
EditproductPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            ...
            _editproduct_routing_module__WEBPACK_IMPORTED_MODULE_5__["EditproductPageRoutingModule"]
        ],
...
let EditproductPage = class EditproductPage {
    ...
    getbasicSubCategoriesList() {
        ...
        //this.util.showLoader();
        this.api.fetchbasicsubcategories((response) => {
            //this.util.hideLoader();
            if (response.status == true) {
    ...
    updateProduct() {
        ...
        this.util.showLoader();
        this.api.updateProduct((response) => {
            this.util.hideLoader();
            if (response.status == true) {
...
EditproductPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./editproduct.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/editproduct/editproduct.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./editproduct.page.scss */ "./src/app/editproduct/editproduct.page.scss")).default]
    })
], EditproductPage);
...
//# sourceMappingURL=editproduct-editproduct-module-es2015.js.map