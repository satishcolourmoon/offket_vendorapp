...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["products-products-module"], {
  ...
  function srcAppProductsProductsPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _filter_filter_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ../filter/filter.page */
    "./src/app/filter/filter.page.ts");

    var ProductsPage = /*#__PURE__*/function () {
      function ProductsPage(util, actRoute, router, api, popoverController, loadingCtrl, alertController, modalController) {
      ...
      _createClass(ProductsPage, [{
                  ...
                  case 0:
                    ...
                    this.api.getPackageReport(function (response) {
                      if (response.status == true) {
                        _this.product = response.products;
                      } else {
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  ...
                  case 3:
                    ...
                    loading.present();
                    this.products = [];
                    this.api.fetchProducts(function (response) {
                      loading.dismiss();

                      if (response.status == true) {
                        _this2.products = response.product_list;
                        _this2.nval = true;
                      } else {
                        _this2.nval = false; //this.util.presentToast(response.message, 'danger', 'bottom', 2500);
                      }
                    }, productObj);
                    ...
                    return this.alertController.create({
                      ...
                      buttons: [{
                        ...
                        handler: function handler() {
                          ...
                          _this3.api.deleteProducts(function (response) {
                            if (response.status == true) {
        ...
        key: "requestProject",
        value: function requestProject(shopId, product, catId) {
          if (product == true) {
            this.router.navigate(['/request-new-product/' + shopId + '/' + catId]);
          } else {
            this.util.presentToast("Your Package Limit Exceeded ", 'danger', 'bottom', 2500); //this.router.navigate(['plans']);
          }
        }
      }, {
        key: "getItems",
        value: function getItems(ev) {
          ...
          if (keyword.length == 0) {
            ...
            this.api.searchProductsList(function (response) {
              if (response.status == true) {
                _this4.products = response.product_list;
                _this4.nval = true;
              } else {
                _this4.nval = false;
                _this4.products = []; //this.util.presentToast(response.message, 'danger', 'bottom', 2500);
              }
            }, catObj);
          }
        }
                ...
                switch (_context4.prev = _context4.next) {
                  ...
                  case 2:
                    ...
                    modal.onDidDismiss().then(function (data) {
                      ...
                      if (json_data.length == 0 || json_data.length == undefined) {} else {
                        var filterObj = {
                          action: "products_brand_filters",
                        ...
                        _this5.api.productsBrandFilters(function (response) {
                          _this5.catId = _this5.actRoute.snapshot.paramMap.get('catId');
                          _this5.catName = _this5.actRoute.snapshot.paramMap.get('catName');
                          _this5.shopId = _this5.actRoute.snapshot.paramMap.get('shop_id');
                          _this5.subcatId = _this5.actRoute.snapshot.paramMap.get('subcatId'); //this.util.hideLoader();
